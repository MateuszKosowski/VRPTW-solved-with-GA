...
\section{Crossover}
Crossover łączy dwa genomy w nowy, zachowując część kolejności z jednego rodzica i uzupełniając brakujące elementy z drugiego.
...
\begin{itemize}
    ...
    \item \textbf{Prawdopodobieństwo mutacji} - mutacja wprowadza nowe struktury tras i pomaga uniknąć utknięcia w lokalnych minimach; jednak przy badanych parametrach nie miała znaczącego wpływu na jakość uzyskiwanych wyników.
\end{itemize}
